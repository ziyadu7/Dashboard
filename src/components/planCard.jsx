...
function PlanCard({ plan }) {
    return (
        <div className="p-6 bg-white border hover:cursor-pointer drop-shadow-2xl border-gray-200 overflow-hidden rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <button className={`flex ${'bg-'+plan?.color||'bg-amber-200'||'bg-red-400'||'bg-pink-300'} items-center px-4 py-1 rounded-md text-sm font-medium text-center`}>Get Started <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
